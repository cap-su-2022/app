...
import {ChevronDoubleLeftIcon, ChevronDoubleRightIcon, ExclamationCircleIcon} from "react-native-heroicons/outline";
...
const ChooseRoomBookingFooter: React.FC<ChooseRoomBookingFooterProps> = (props) => {
