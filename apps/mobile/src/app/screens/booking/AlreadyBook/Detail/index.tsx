...
const AlreadyBookDetail: React.FC<any> = (props) => {
  const currentBookingRoom = useAppSelector(
    (state) => state.roomBooking.currentBookingRoom
  );
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Room {currentBookingRoom.roomName}
            </Text>
          </View>
          ...
          >
            <InfoDetail
              title={'Book At'}
              detail={dayjs(currentBookingRoom.bookedAt).format(
                'HH:mm:ss DD/MM/YYYY'
              )}
            />
            <InfoDetail
              title={'Check-in at'}
              detail={dayjs(currentBookingRoom.timeCheckIn).format(
                'HH:mm:ss DD/MM/YYYY'
              )}
            />
            <InfoDetail
              title={'Request at'}
              detail={dayjs(currentBookingRoom.requestedAt).format(
                'HH:mm:ss DD/MM/YYYY'
              )}
            />
          </View>
