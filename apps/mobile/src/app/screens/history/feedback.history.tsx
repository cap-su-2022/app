        ...
        <View style={[styles.container]}>
          <View style={[styles.searchContainer]}>
            <View style={[styles.searchInputContainer]}>
              ...
              <TouchableOpacity onPress={() => navigate.navigate('FEEDBACK_HISTORY_FILTER')} style={{
                display: 'flex',
          ...
          <View style={[styles.feedbackItemContainer]}>
            <View style={[styles.feedbackItem]}>
              <View>
                <View style={[styles.feedbackIconContainer]}>
                  ...
                  <ClockIcon color={FPT_ORANGE_COLOR} style={[styles.feedbackInProgressIconStatus]}/>
              </View>
            ...
            <Text style={[styles.feedbackInProgressText]}>
              IN PROGRESS
            </Text>
          </View>
          ...
          <View style={[styles.feedbackItemContainer]}>
            ...
            <Text style={[styles.feedbackRejectText]}>
              REJECTED
            </Text>
          </View>
