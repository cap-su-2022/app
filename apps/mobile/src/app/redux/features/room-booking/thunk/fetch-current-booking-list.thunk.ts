...
export const fetchCurrentBookingRoomList = createAsyncThunk<CurrentBookingRoom[], void, {
  rejectValue: {
    message: string
  }
  ...
  try {
     const response = await axios.get(`${API_URL}/booking-room/current-booking-list`, {
       headers: {
