...
const get_all_booking_rooms_filter_payload_1 = __webpack_require__("./apps/backend/src/app/payload/request/get-all-booking-rooms-filter.payload.ts");
let BookingRoomController = BookingRoomController_1 = class BookingRoomController {
    ...
    getDevicesUseInRequest(requestId) {
...
/***/ "./apps/backend/src/app/models/booking-request-devices.entity.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BookingRequestDevices = void 0;
const tslib_1 = __webpack_require__("tslib");
const typeorm_1 = __webpack_require__("typeorm");
let BookingRequestDevices = class BookingRequestDevices {
};
tslib_1.__decorate([
    (0, typeorm_1.PrimaryGeneratedColumn)("uuid", {
        name: "id",
    ...
    tslib_1.__metadata("design:type", String)
], BookingRequestDevices.prototype, "id", void 0);
tslib_1.__decorate([
    (0, typeorm_1.Column)({
    ...
    tslib_1.__metadata("design:type", String)
], BookingRequestDevices.prototype, "bookingRequestId", void 0);
tslib_1.__decorate([
    (0, typeorm_1.Column)({
        name: "device_id",
        type: "uuid",
    ...
    tslib_1.__metadata("design:type", String)
], BookingRequestDevices.prototype, "deviceId", void 0);
tslib_1.__decorate([
    (0, typeorm_1.Column)({
        name: "device_quantity",
    }),
    tslib_1.__metadata("design:type", Number)
], BookingRequestDevices.prototype, "deviceQuantity", void 0);
BookingRequestDevices = tslib_1.__decorate([
    (0, typeorm_1.Entity)("booking_request_devices")
], BookingRequestDevices);
exports.BookingRequestDevices = BookingRequestDevices;
...
tslib_1.__exportStar(__webpack_require__("./apps/backend/src/app/models/booking-request-devices.entity.ts"), exports);
...
const slot_module_1 = __webpack_require__("./apps/backend/src/app/modules/slot.module.ts");
const booking_request_devices_service_1 = __webpack_require__("./apps/backend/src/app/services/booking-request-devices.service.ts");
const booking_request_devices_repository_1 = __webpack_require__("./apps/backend/src/app/repositories/booking-request-devices.repository.ts");
    ...
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_ex_module_1.TypeOrmExModule.forCustomRepository([
                ...
                booking_request_devices_repository_1.BookingRoomDevicesRepository
            ]),
        ],
        controllers: [controllers_1.BookingRoomController],
        providers: [services_1.BookingRoomService, task_service_1.TasksService, booking_room_hist_service_1.BookingRequestHistService, booking_request_devices_service_1.BookingRoomDevicesService],
        exports: [services_1.BookingRoomService, booking_room_hist_service_1.BookingRequestHistService, booking_request_devices_service_1.BookingRoomDevicesService],
    })
], BookingRoomModule);
...
const GlobalTypeOrmModule = typeorm_1.TypeOrmModule.forRootAsync({
    ...
    useFactory: (configService) => ({
        ...
        entities: [
            ...
            models_1.BookingRequestDevices,
        ],
...
], BookingRequestAddRequestPayload.prototype, "listDevice", void 0);
...
/***/ "./apps/backend/src/app/payload/request/get-all-booking-rooms-filter.payload.ts":
/***/ ((__unused_webpack_module, exports) => {
    ...
    createNewAccount(payload, userId) {
        if (payload.isDisabled) {
            this.createQueryBuilder('a').where((qb) => {
                qb.where("booking_request.status = 'PENDING'").orWhere("booking_request.status = 'BOOKED'");
            });
            return this.save({
...
/***/ "./apps/backend/src/app/repositories/booking-request-devices.repository.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BookingRoomDevicesRepository = void 0;
const tslib_1 = __webpack_require__("tslib");
const typeorm_1 = __webpack_require__("typeorm");
const models_1 = __webpack_require__("./apps/backend/src/app/models/index.ts");
const typeorm_ex_decorator_1 = __webpack_require__("./apps/backend/src/app/decorators/typeorm-ex.decorator.ts");
let BookingRoomDevicesRepository = class BookingRoomDevicesRepository extends typeorm_1.Repository {
    findByRequestId(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return this.createQueryBuilder('brd')
                ...
                .innerJoin(models_1.Devices, 'd', 'd.id = brd.device_id')
                .where('brd.booking_request_id = :id', { id: id })
                .getRawMany();
        });
    }
    addDeviceToRequest(bookingRequestId, deviceId, quantity, queryRunner) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield queryRunner.manager.save(models_1.BookingRequestDevices, {
...
BookingRoomDevicesRepository = tslib_1.__decorate([
    (0, typeorm_ex_decorator_1.CustomRepository)(models_1.BookingRequestDevices)
], BookingRoomDevicesRepository);
exports.BookingRoomDevicesRepository = BookingRoomDevicesRepository;
...
let BookingRoomRepository = class BookingRoomRepository extends typeorm_1.Repository {
    ...
    findBookingRoomRequestsByFilter(filters) {
        const query = this.createQueryBuilder('booking_request')
            .select('booking_request.id', 'id')
            .addSelect('r.name', 'roomName')
...
/***/ "./apps/backend/src/app/services/booking-request-devices.service.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


var BookingRoomDevicesService_1, _a, _b;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BookingRoomDevicesService = void 0;
const tslib_1 = __webpack_require__("tslib");
const common_1 = __webpack_require__("@nestjs/common");
const typeorm_1 = __webpack_require__("typeorm");
const booking_request_devices_repository_1 = __webpack_require__("./apps/backend/src/app/repositories/booking-request-devices.repository.ts");
let BookingRoomDevicesService = BookingRoomDevicesService_1 = class BookingRoomDevicesService {
    constructor(dataSource, repository) {
        this.dataSource = dataSource;
        this.repository = repository;
        this.logger = new common_1.Logger(BookingRoomDevicesService_1.name);
    }
    findByRequestId(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.repository.findByRequestId(id);
            }
            catch (e) {
                this.logger.error(e.message);
                throw new common_1.BadRequestException(e.message);
    ...
    addDeviceToRequest(bookingRequestId, payload, queryRunner) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                if (payload) {
                    const bookingRequestDevices = [];
                    for (let i = 0; i < payload.length; i++) {
                        const result = yield yield this.repository.addDeviceToRequest(bookingRequestId, payload[i].value, payload[i].quantity, queryRunner);
...
BookingRoomDevicesService = BookingRoomDevicesService_1 = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof typeorm_1.DataSource !== "undefined" && typeorm_1.DataSource) === "function" ? _a : Object, typeof (_b = typeof booking_request_devices_repository_1.BookingRoomDevicesRepository !== "undefined" && booking_request_devices_repository_1.BookingRoomDevicesRepository) === "function" ? _b : Object])
], BookingRoomDevicesService);
exports.BookingRoomDevicesService = BookingRoomDevicesService;
...
var BookingRoomService_1, _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
Object.defineProperty(exports, "__esModule", ({ value: true }));
...
let BookingRoomService = BookingRoomService_1 = class BookingRoomService {
    constructor(dataSource, roomService, roomTypeService, deviceService, roomWishlistService, repository, accountService, slotService, bookingRoomDeviceService, histService) {
        this.dataSource = dataSource;
        ...
        this.bookingRoomDeviceService = bookingRoomDeviceService;
        this.histService = histService;
    ...
    getDevicesUseInRequest(requestId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.bookingRoomDeviceService.findByRequestId(requestId);
            }
            catch (e) {
                this.logger.error(e);
                throw new common_1.BadRequestException('An error occurred while getting request by account id ' + requestId);
            }
        });
    }
    ...
    getBookingRoomById(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const requestInfo = yield this.repository.findById(id);
                if (requestInfo) {
                    const listDevice = yield this.bookingRoomDeviceService.findByRequestId(id);
                    return Object.assign(Object.assign({}, requestInfo), { listDevice: listDevice });
                }
                else {
                    throw new common_1.BadRequestException('Not found request with provided id');
                }
            }
            catch (e) {
                this.logger.error(e.message);
    ...
    addNewRequest(payload, userId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.bookingRoomDeviceService.addDeviceToRequest(request.id, payload.listDevice, queryRunner);
