...
function UsersPage() {
  ...
  useEffect(() => {
    dispatch(fetchUsers()).unwrap().catch((e) => {
  ...
  return (
    <AdminLayout>
      ...
      />
      <InfoModal isShown={isDetailModalShown}
                 toggleShown={() => setDetailModalShown(!isDetailModalShown)}
                 toggleDisableModalShown={() => setDisableModalShown(!isDisableModalShown)}
      />
      <DisableModal isShown={isDisableModalShown}
      ...
      <AddDeviceModal isShown={isAddModalShown}
